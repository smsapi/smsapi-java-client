...
public class VMSSendTest {
    ...
    @Test
    public void executeSendVmsWithOptionalFieldsRequest() throws SmsapiException {
        ProxyRequestSpy requestStub = new ProxyRequestSpy(StatusJsonMother.create());
        VMSSend action = new VMSSend("48123123123", "text to speech")
            .setSkipGsm(true)
            .setTtsLector(VMSSend.Lector.EWA)
            .setInterval(1000)
            .setFrom("test");
        ...
        expectedRequestPayload.put("to", "48123123123");
        expectedRequestPayload.put("format", "json");
        expectedRequestPayload.put("skip_gsm", "1");
        expectedRequestPayload.put("tts_lector", "ewa");
        expectedRequestPayload.put("interval", "1000");
